...
@Component
public class ApplicationCreateRequestDTOValidator extends BaseValidator<ApplicationCreateRequestDTO> {
    private String applicantEntitlementRate="Applicant Entitlement Rate";
    private String nationalNo="National No";
    ...
    @Override
    public void validate(ApplicationCreateRequestDTO dto) {

        checkDecimalRange(dto.getApplicantEntitlementRate(),applicantEntitlementRate,new BigDecimal("0.0"),new BigDecimal("1.0"));

        checkNotNull(dto.getNationalityNo(),nationalNo);
        checkNotBlank(dto.getNationalityNo(),nationalNo);
        checkLength(dto.getNationalityNo(),nationalNo,1,10);
        ...
        checkNotNull(dto.isAnonymous(),isAnonymous);
