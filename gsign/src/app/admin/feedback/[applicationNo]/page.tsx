...
export default function AdminFeedbackPage() {
  ...
  const {
    feedbackCategories: categoriesData,
  ...
  useEffect(() => {
    register("selectedCategories", {
      required: "Please select at least one feedback category",
      validate: (value) =>
    ...
    register("attachedFiles", {
      required: false, // File upload is optional for feedback
    });
  }, [register]);

  // Transform feedback categories for EDK UI Select
  const feedbackCategories = categoriesData.map((category) => ({
    value: category.id.toString(),
    label: category.feedbackCategoryDescription,
  }));
  ...
  // Category change handler for Select component
  ...
  const onSubmit = async () => {
    ...
    try {
      ...
      const feedbackCategoryIds = selectedCategories.map((cat) =>
        parseInt(cat)
      );

      const success = await sendFeedback({
        applicationNo,
        feedbackCategories: feedbackCategoryIds,
      ...
      setFormErrors(["Failed to send feedback. Please try again."]);
    }
  };
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Provide feedback for patent application review
          </p>
        </div>
        ...
        <div className="p-6 bg-white shadow-sm border border-gray-200 rounded-lg">
          ...
          <div className="space-y-6">
            {/* Feedback Categories - EDK UI Multiple Select */}
              ...
              >
                <div style={{ width: "100%" }}>
                  <Select
                    ...
                    placeholder="Select feedback categories..."
                  />
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <p className="text-sm text-blue-800 font-medium">
                    &quot;You are about to send feedback for this patent
                    application.&quot;
                  </p>
                  <p className="text-sm text-blue-700 mt-1">
                    This allows the applicant to make revisions based on your
          ...
          <div className="flex justify-end space-x-4 mt-8 pt-6 border-t border-gray-200">
            ...
            <button
              ...
              disabled={sending}
              className="px-6 py-2 bg-blue-600 text-white text-sm font-medium rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center"
            >
              {sending ? (
                <>
                  <LoadingSpinner
      ...
      >
        <div className="flex flex-col items-center p-6 text-center">
          ...
          <p className="text-gray-600 mb-6">
            Your feedback has been sent to the applicant and they will be
            notified.
          </p>
